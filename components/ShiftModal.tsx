...
const ShiftModal: React.FC<ShiftModalProps> = ({ isOpen, onClose, shift, mode, onSave, onDelete }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center transition-opacity duration-300 opacity-100">
      ...
      <div className="relative bg-white dark:bg-[#1e1e1e] w-full md:w-[480px] rounded-t-[3rem] md:rounded-[3rem] shadow-2xl border border-white dark:border-white/5 overflow-hidden transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] will-change-transform translate-y-0">
        ...
        <div className="px-8 pb-10 space-y-6">
          ...
          <div className="flex gap-4 pt-2">
             {(!isFact || (isFact && shift.isWorkDay)) && shift.isWorkDay && (
                <button
                  onClick={onDelete}
